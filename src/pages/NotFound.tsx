          ...
          <div className="lg:pt-12 lg:pb-12 pt-24 px-4">
            <div className="grid lg:px-10 px-2 py-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-6 gap-y-6 justify-center">
              <div className="grid-col m-auto lg:pl-10">
                ...
                <p className="mb-8">
                  Oups ! On dirait que vous vous êtes égaré sur mon site. Mais
                  pas de soucis, vous pouvez retourner sur la page
                  d&apos;accueil en cliquant sur le bouton :
                </p>
                <NavLink
                  to="/home"
                  onClick={() => {
                ...
                >
                  <button className="menu-item-two-active">
